...
describe('FeatureStep component', () => {
  ...
  it('renders without crashing', () => {
    render(<FeatureStep icon={<span>Icon</span>} title="Test Title" isDisabled={false} />);
  ...
  it('displays children when provided', () => {
    render(
      <FeatureStep icon={<span>Icon</span>} title="Test Title" isDisabled={false}>
  ...
  it('adds "is-disabled" class when isDisabled is true', () => {
    render(
      <FeatureStep icon={<span>Icon</span>} title="Test Title" isDisabled={true} />
    );
