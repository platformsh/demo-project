...
describe('DesignDebugger', () => {
  ...
  it('initializes with default props', () => {
    ...
    // @ts-ignore
    expect(screen.getByTestId('environmentInput').value).toBe(defaultProps.defaultEnvironment);
    // @ts-ignore
    expect(screen.getByTestId('sessionStorageTypeInput').value).toBe(defaultProps.defaultStorage);
